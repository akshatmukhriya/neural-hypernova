# --- NEURAL HYPERNOVA: INDUSTRIAL INFRASTRUCTURE V37.0.0 ---
...
# --- 1. DATA SOURCES & GLOBAL IDENTITY ---
...
module "eks" {
  ...
  eks_managed_node_groups = {
    brain = {
      ...
      # Mandatory Role name for Karpenter V1.x Discovery
...
# --- 4. KARPENTER CONTROLLER IDENTITY (The IRSA Key) ---
